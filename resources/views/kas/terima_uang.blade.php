...
<div class="card">
		...
		<div class="header-elements">
			<div class="btn-group">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a href='#' value="{{ route('showJurnalTerimauang', $data->id ?? 0) }}" class="dropdown-item modalMd" title="Jurnal" data-toggle="modal" data-target="#modalMd" data-backdrop="static" data-keyboard="false"> Lihat Jurnal</a>
				</div>
			</div>
		</div>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12">
				<form method="POST" action="{{ route('terimaUangUpdate') }}">
					<fieldset>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<select name="akunsetorid" class="select-search" required data-placeholder="Pilih">
									<option value=""></option>
									@foreach($akunx as $r)
									<option value="{{$r->id}}" <?php if (($data->akunsetorid ?? $id) == $r->id) echo 'selected';
						...
						<div class="form-group row">
							<label class="col-form-label col-sm-2">Yang Membayar</label>
							<div class="col-sm-5">
								<input type="text" name="dari" placeholder="" class="form-control" value="{{ $data->dari ?? old('dari') }}">
							</div>
						</div>
						<div class="form-group row">
						...
						<div hidden class="form-group row">
							<div class="col-sm-10">
								<input type="text" id="kolom" class="form-control tokenfield" placeholder="+ Kolom" value="No,Terima Dari,Deskripsi,Jumlah" data-fouc>
						...
						<input type="hidden" name="txnamakolom" id="txnamakolom" value="No,Terima Dari,Deskripsi,Jumlah">
						...
						<div class="form-group row mt-1">
							<div class="col-sm-11">
								...
								<div class="list-icons" style="float: right;">
									<a href="{{ action('KeuanganCont@destroyTerimauang',['id'=>$data->id ?? 0]) }}" onclick="return confirm('Anda yakin ingin menghapus data Jurnal ini ?')" class="btn btn-outline-warning btn-sm" style="margin-right: 50px;">Hapus</a>
									...
									@else
									<a href="{{ route('editTerimaUang',$data->id ?? '') }}" class="btn btn-outline-info btn-sm" title="Ubah Data">Ubah</a>
									@endif
								</div>
							</div>
						</div>
