    ...
    <div class="card-header  header-elements-inline">
        ...
        <div class="header-elements">
            <div class="list-icons">
                <a class="btn btn-outline-info" href="{{ action('PembelianPenawaranCont@create') }}" title="Input Data Penawaran Pembelian" > <i class="icon-plus2"></i> Penawaran Pembelian</a>
            </div>
        </div>
    </div>
    ...
    <table class="table basic">
        ...
        @foreach($data as $row)
            <tr>
                ...
                <td><a href="{{ route('show_pq',$row->id) }}"  class="list-icons-item text-teal-800" title="Detail Data" >{{ '#'.$row->kode }}</a></td>
                ...
                <td class="text-center">
                    <div class="list-icons">
                        ...
                        <a href="{{ action('PembelianPenawaranCont@destroy',['id'=>$row->id]) }}" class="list-icons-item text-danger-600" title="Hapus Data" onclick="return confirm('Anda yakin ingin menghapus data ini ??')" ><i class="icon-bin"></i></a>
                    </div>
                </td>
            </tr>
        @endforeach
