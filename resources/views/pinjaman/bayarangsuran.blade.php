...
<div class="card">
    <div class="card-header  header-elements-inline">
        ...
        <div class="header-elements">
             <a href="{{ route('daftarAngsuran') }}" class="btn btn-outline-info btn-sm" >Daftar Angsuran </a>
            <a href="{{ route('bayarAngsuran') }}" class="btn btn-outline-info btn-sm ml-1" ><i class="icon-plus2"></i> Pembayaran Angsuran </a>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="form-group row">
            <label class="col-form-label col-sm-2">NAMA ANGGOTA  </label>
            ...
            <div class="col-sm-3">
                 <input type="hidden" id="kodebayar" value="angsuran">
                <button type="button" id="btn_filter" class="btn btn-outline-info btn-sm">Tampilkan Pinjaman</button>
            </div>
        </div>
    </div>
    @endif
