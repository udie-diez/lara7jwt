...
<div class="card">
    <div class="card-body">
        <form method="POST" action = "{{ route('filterAngsuran') }}">
            @csrf
    ...
    <div class="card-header header-elements-inline">
        ...
        <div class="header-elements">
            <div class="list-icons">
                <a class="btn btn-outline-info btn-sm" href="{{ route('bayarAngsuran') }}"   title="Input Pembayaran Angsuran Baru"> <i class="icon-plus2"></i> Bayar Angsuran</a>
            </div>
        </div>
    </div>
    ...
    <table class="table basicx table-hover" id="table_1">
        <thead>
            <tr class="text-center">
                ...
                <th class="export">JUMLAH <br> PEMBAYARAN</th>
                <th class="export">TANGGAL <br> PEMBAYARAN</th>
        ...
        @foreach($data as $row)
            ...
            <tr>
                ...
                <td class="text-center" title="Data Pelunasan">
                    <div class="list-icons">
                        <a href="{{ url('pinjaman/showangsuran').'/'.$row->id }}" id="btn-edit" class="list-icons-item text-info-600" title="Detail Angsuran"  ><i class="icon-eye8"></i></a>
                        <a href="{{ action('PinjamanCont@destroyAngsuran',['id'=>$row->id]) }}" id="btn-del" onclick="return confirm('Anda yakin ingin menghapus data ini ?')" class="list-icons-item text-danger-600" title="Hapus Angsuran"  ><i class="icon-bin"></i></a>
                    </div> 
                </td>
            </tr>
        @endforeach
