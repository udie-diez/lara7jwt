	...
	<div class="page-content">
		...
		<div class="content-wrapper card">
			...
			<div class="content d-flex justify-content-center align-items-center" style="display: none;">
				...
				<!-- Registration form -->
				<form method="POST" action="{{ route('updateResetPassword') }}" class="flex-fill form-validate-jquery">
					@csrf
					<div class="row">
							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="text-center mb-5">
										...
										<span class="d-block">Anda akan melakukan reset Password, silahkan memasukkan password baru Anda !</span>
									</div>
									...
									<div class="text-center">
										<button type="submit" class="btn bg-info">Reset</button>
									</div>
								</div>
							</div>
						</div>
				...
				<!-- /registration form -->
				@elseif($status==2)
					<h2 class="text-center">Selamat password Anda sudah tereset, silahkan klik tombol Login untuk mulai.<br><br>
